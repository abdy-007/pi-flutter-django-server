...
**NOT checked!!!, if any issues create an "issue" so I will start working on it. You can also try to solve yourself with AI just don't forget to commit afterwards!!!**
<br>
